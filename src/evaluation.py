...
def get_performance(
    ...
    precision = metrics.precision_score(y_test, predictions, average="binary", pos_label=0)
    # Use sklearn.metrics.recall_score
    recall = metrics.recall_score(y_test, predictions, average="binary", pos_label=0)
    # Use sklearn.metrics.f1_score
    f1_score = metrics.f1_score(y_test, predictions, average="binary", pos_label=0)
    # Use sklearn.metrics.classification_report
    report = metrics.classification_report(y_test, predictions, target_names=[str(label) for label in labels])
